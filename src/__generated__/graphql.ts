          ...
          { kind: "Field", name: { kind: "Name", value: "averageRating" } },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "secure_url" } },
              ],
            },
          },
        ],
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "getLandingProducts" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
...
export const GetSearchProductsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetSearchProducts" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "searchHomeProducts" },
            arguments: [
              {
                kind: "Argument",
